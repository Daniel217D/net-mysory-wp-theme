 ...
 */
function net_mysory_custom_colors_css() {
	 ...
	 */
	$saturation         = absint( apply_filters( 'net_mysory_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.net_mysory-front-page) .entry-title,
...
.colors-custom .net_mysory-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.net_mysory-front-page .panel-content .recent-posts article,
...
.colors-custom.net_mysory-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'net_mysory_custom_colors_css', $css, $hue, $saturation );
}
