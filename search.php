...
<div class="wrap">
	...
	<header class="page-header">
		<?php if ( have_posts() ) : ?>
			...
			printf( __( 'Search Results for: %s', 'net_mysory' ), '<span>' . get_search_query() . '</span>' );
			?>
			</h1>
		<?php else : ?>
	...
	<div id="primary" class="content-area">
		...
		if ( have_posts() ) :
			...
			<p><?php _e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'net_mysory' ); ?></p>
			<?php
				get_search_form();
